...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ SK Movies Offl ⚡', url='https://t.me/SK_MoviesOffl')
            ],
            [
                InlineKeyboardButton('⚡ Request Group ⚡', url=f"https://t.me/+v6VsDaE-6hk2NDFl"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SK Movies Offl ⚡', url='https://t.me/SK_MoviesOffl'),
            InlineKeyboardButton('⚡ Request Group ⚡', url='https://t.me/+v6VsDaE-6hk2NDFl')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('❤️️JOIN❤️️', url='https://t.me/SK_MoviesOffl') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
